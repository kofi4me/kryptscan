...
def scanner_health(user: Row = Depends(get_current_user)) -> dict:
    ...
    tools = [
        ...
        _tool_health("Feroxbuster", settings.feroxbuster_path, "Web Content Discovery"),
        _tool_health("ffuf", settings.ffuf_path, "Web Content Discovery"),
        _tool_health("Gobuster", settings.gobuster_path, "Web Content Discovery"),
